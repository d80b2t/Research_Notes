...
\subsection{15 key Python Libraries for Data Science in 2021}
\href{https://www.analyticsvidhya.com/blog/2021/04/top-15-python-libraries-you-must-know-for-data-science-in-2021/}{https://www.analyticsvidhya.com/blog/2021/04/top-15-python-libraries-you-must-know-for-data-science-in-2021/} \\

\noindent
\begin{tabular}{ l l  }
{\tt BeautifulSoup}  &  web crawling and data scraping \\
{\tt LightGBM} &  gradient boosting framework; \\
{\tt Keras} &  train deep learning models; \\
{\tt Matplotlib} &  data visualization \\
{\tt numpy}  & scientific operations \\
{\tt pandas} & data analysis and manipulation \\
{\tt PyTorch} & open-source machine learning and deep learning framework \\
{\tt sciPy} &  solving scientific, mathematical, and technical problems.\\
{\tt scikit-learn} & machine learning \\
{\tt TensorFlow} & end-to-end platform for creating Machine Learning applications' \\
{\tt Plotly} &  data visualization \\
{\tt Pycaret} & low-code machine learning library \\
{\tt Scrapy} &  extracting data from websites \\
{\tt Seaborn} &  data visualization \\
{\tt XGBoost} &  gradient boosting library \\
\end{tabular}
...
\href{https://www.analyticsvidhya.com/blog/2021/04/an-overview-of-python-memory-management/}{https://www.analyticsvidhya.com/blog/2021/04/an-overview-of-python-memory-management/}
