...
See also ``General\_Physical\_terms''
\end{abstract}
...
\begin{itemize}
\item{  {\bf Hard State:} A}
\item{{\bf Hardness Ratio:} }
\item{{\bf Parandell Instability:} }
\item{{\bf QPOs:} }
\item{{\bf S-curve Instability:} }
\item{{\bf S-curve Instability filp:} }
\item{{\bf Soft State:} }
\end{itemize}
